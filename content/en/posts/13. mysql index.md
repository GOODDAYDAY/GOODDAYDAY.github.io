...
3. But, as to (id, begin) part, begin > 1234567894000 always filter more data, which the time always be `now`.

> So the better one is (id, begin, end)
...
- INDEX idx_payment_statue(statue)
