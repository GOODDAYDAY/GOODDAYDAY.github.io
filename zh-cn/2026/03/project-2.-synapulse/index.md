# [Project] 2. Synapulse — 自托管的个人 AI 助手
...
|                                 天气查询                                  |                                 搜索推荐                                 |
|:---------------------------------------------------------------------:|:--------------------------------------------------------------------:|
| ![天气](/images/Project%20-%202%20-%20Synapulse/1.%20what%20is%20the%20weather%20today.gif) | ![键盘推荐](/images/Project%20-%202%20-%20Synapulse/2.%20recommend%20me%20one%20keyboard.gif) |

|                                       提醒 — 通知模式                                       |                                提醒 — AI 执行模式                                 |
|:-------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|
| ![通知](/images/Project%20-%202%20-%20Synapulse/3.%20notify%20me%20drink%20water%20after%201%20minutes..gif) | ![AI 执行](/images/Project%20-%202%20-%20Synapulse/4.%20notify%20me%20news%20after%201%20minutes.gif) |

|                                                   创建文件并发送                                                   |
|:-----------------------------------------------------------------------------------------------------------:|
| ![文件](/images/Project%20-%202%20-%20Synapulse/5.%20create%20a%20file%20contains%20news%20about%20irar%20and%20send%20to%20me..gif) |
...
| **Shell 执行** | AI 主动使用 Shell 命令处理系统查询、计算、Git 操作等。跨平台：Windows 使用 PowerShell，Linux/macOS 使用 bash |
| **持久记忆** | 对话自动保存和摘要，跨会话记忆 |
| **任务管理** | 支持优先级和截止日期的待办事项，AI 主动感知待办任务 |
| **备忘录** | 通过自然语言保存和搜索个人笔记 |
| **提醒** | 支持相对时间（`+5m`、`+1h`）和绝对时间。两种模式：**通知模式**用于被动提醒，**AI 执行模式**用于定时 AI 任务（如"1小时后告诉我天气"） |
